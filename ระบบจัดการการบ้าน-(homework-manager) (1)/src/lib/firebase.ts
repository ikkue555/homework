...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  statProgressChartTitle: 'สรุปสถานะความคืบหน้าการบ้าน (Progress Breakdown)',
  statProgressChartSubtitle: 'แผนภูมิวงกลมจำแนกตามขั้นตอนการทำการบ้าน',
  statAvgProgressLabel: 'ความคืบหน้าเฉลี่ย:',
  ...
  emptyCompletedTitle: 'ยังไม่มีการบ้านที่ทำเสร็จแล้ว',
  emptyCompletedMessage: 'เมื่อทำการบ้านเสร็จและกดปุ่มเสร็จสมบูรณ์ รายการจะมาปรากฏที่นี่',
  emptyOverdueTitle: 'เยี่ยมมาก! ไม่มีงานที่เลยกำหนดส่งในขณะนี้',
  emptyOverdueMessage: 'คุณส่งงานตรงเวลาอย่างสม่ำเสมอ รักษามาตรฐานที่ดีแบบนี้ไว้นะ!',
  emptyNewsTitle: 'ยังไม่มีข่าวประชาสัมพันธ์',
  emptyNewsMessage: 'ยังไม่มีการโพสต์ข่าวใหม่ในขณะนี้',

  cardDuePrefix: 'กำหนดส่ง:',
  cardNoDueDateText: 'ไม่มีกำหนดส่ง',
  cardNoDueTimeText: 'ไม่มีเวลากำหนด',
  cardDueTodayBadge: 'ส่งวันนี้!',
  cardOverdueBadgePrefix: 'เลยกำหนด',
  cardDaysLeftPrefix: 'อีก',
  cardDaysUnit: 'วัน',
  cardViewDetailButton: 'ดูรายละเอียด',
  cardCompletedButton: 'เสร็จแล้ว',
  cardMarkDoneButton: 'เสร็จ',
  cardSharedByPrefix: 'แชร์โดย:',

  formAddTitle: 'เพิ่มการบ้านใหม่',
  formEditTitle: 'แก้ไขข้อมูลการบ้าน',
  formSubjectLabel: 'ชื่อวิชา',
  formTitleLabel: 'หัวข้องาน',
  formDueDateLabel: 'วันกำหนดส่ง',
  formDueTimeLabel: 'เวลากำหนดส่ง',
  formNoDueDateOption: 'ยังไม่มีกำหนดส่ง',
  formNoDueTimeOption: 'ไม่มีเวลากำหนด',
  formWorkTypeLabel: 'รูปแบบงาน',
  formWorkTypeSingle: 'งานเดี่ยว',
  formWorkTypeGroup: 'งานกลุ่ม',
  formDescriptionLabel: 'รายละเอียดของงาน',
  formPriorityLabel: 'ระดับความสำคัญ',
  formInitialProgressLabel: 'ความคืบหน้าเริ่มต้น:',
  formSubmitAddButton: 'บันทึกการบ้านใหม่',
  formSubmitEditButton: 'บันทึกการแก้ไข',

  friendsModalTitle: 'ระบบเพื่อน & แชร์การ์ดการบ้าน 3D',
  friendsModalSubtitle: 'เลือกสำรับการ์ดการบ้าน 3D TCG แล้วส่งต่อให้เพื่อนร่วมชั้นเรียน',
  friendsStep1Title: 'ขั้นตอนที่ 1/2: เลือกการ์ดการบ้านที่ต้องการแชร์',
  friendsStep2Title: 'ขั้นตอนที่ 2/2: เลือกเพื่อนที่จะรับการ์ดการบ้าน',
  friendsTabShare: 'แชร์การบ้าน (สำรับการ์ด)',
  friendsTabMyFriends: 'เพื่อนของฉัน',
  friendsTabAddFriend: 'เพิ่มเพื่อน',
  friendsTabRequests: 'คำขอเป็นเพื่อน',
  friendsSelectAllButton: 'เลือกทั้งหมด',
  friendsDeselectAllButton: 'ล้างที่เลือก',
  friendsNextStepButton: 'เลือกเสร็จแล้ว → ไปเลือกเพื่อนที่จะแชร์',
  friendsConfirmShareButton: 'ยืนยันแชร์การบ้าน',
  ...
  footerLiveSyncText: 'ซิงค์ Firestore Cloud เรียลไทม์',
  footerDevCredit: 'สำหรับนักเรียนทุกคน',
